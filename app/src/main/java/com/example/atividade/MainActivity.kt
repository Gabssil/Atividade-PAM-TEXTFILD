...
import com.example.atividade.ui.theme.NotaIButtonColors
import com.example.atividade.ui.theme.NotaRButtonColors
import com.example.atividade.ui.theme.NotaBButtonColors
import com.example.atividade.ui.theme.NotaMBButtonColors
...
fun cadastro() {
    ...
    Column (Modifier.fillMaxWidth(),){
        Row (Modifier.fillMaxWidth(), Arrangement.Center){
            Image(painter = painterResource(com.example.atividade.R.drawable.logo), contentDescription = "Etec")
            Spacer(modifier = Modifier.width(60.dp)) //Adiciona espaço na vertical

            Text(text = "ATIVIDADE - Gabriela do Carmo", fontSize = 20.sp)
        }
